...
java -Xms128m -Xmx1024m -XX:MaxPermSize=256m -Xdebug -Xrunjdwp:transport=dt_socket,server=y,suspend=y,address=8000  -Dproject.root=$BASEDIR -jar org.liveSense.launchpad-1.0.2-SNAPSHOT-standalone.jar -p 8080 | sed  \
